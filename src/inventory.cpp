...
void _CR_0(const MoveAction &_1, int _, ServerActiveObject *_0) {}
void _CR_1(const MoveAction &_, const ItemStack &_1, ServerActiveObject *p) {}
int _CR_2(const MoveAction &_, const ItemStack &_1, ServerActiveObject *p) {}
void _CR_3(const MoveAction &_, int _0, ServerActiveObject *p) {}
...
{
	AllowMove = reinterpret_cast<_cualifierReturn_0>(_CR_0);
	onPut = reinterpret_cast<_cualifierReturn_1>(_CR_1);
	onTake = reinterpret_cast<_cualifierReturn_1>(_CR_1);
	onMove = reinterpret_cast<_cualifierReturn_3>(_CR_3);
	AllowPut = reinterpret_cast<_cualifierReturn_2>(_CR_2);
	AllowTake = reinterpret_cast<_cualifierReturn_2>(_CR_2);
	m_itemdef = itemdef;
	setModified();
}
