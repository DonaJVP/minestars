...
const ToServerCommandHandler toServerCommandTable[TOSERVER_NUM_MSG_TYPES] =
{
	...
	{ "TOSERVER_MODCHANNEL_JOIN",          TOSERVER_STATE_INGAME, &Server::handleCommand_Null }, // 0x17
	{ "TOSERVER_MODCHANNEL_LEAVE",         TOSERVER_STATE_INGAME, &Server::handleCommand_Null }, // 0x18
	{ "TOSERVER_MODCHANNEL_MSG",           TOSERVER_STATE_INGAME, &Server::handleCommand_Null }, // 0x19
	...
	{ "TOSERVER_SRP_BYTES_M",              TOSERVER_STATE_NOT_CONNECTED, &Server::handleCommand_SrpBytesM }, // 0x52 __
	null_command_handler,
	null_command_handler,
	null_command_handler,
	null_command_handler,
	null_command_handler,
	{ "TOSERVER_GOT_DISCONNECT",           TOSERVER_STATE_NOT_CONNECTED, &Server::handleCommand_GotDisconnect }, // 0x58
	{ "TOSERVER_GOT_CONNECT",              TOSERVER_STATE_NOT_CONNECTED, &Server::handleCommand_GotConnect }, // 0x59
