...
public:
	...
	*/
	...
	virtual std::string getClientInitializationData(u16 protocol_version, u16 ID) {return "";}
	virtual std::string GetInitData(u16 proto) {return "";}
	...
	*/
	...
	void setMapID(uint16_t mapid) { m_mapid = mapid; }
...
protected:
	...
	*/
	MultithreadQueue<ActiveObjectMessage> m_messages_out;
};
