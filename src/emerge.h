...
public:
	...
	// Methods
	EmergeManager(Server *server, HyperMap *MapStruct);
	~EmergeManager();
...
private:
	...
	HyperMap *m_map_D = nullptr;

	friend class EmergeThread;
};

//Friendliness callbacks

using _EMERGE_CB_onGenerated_V = void(*)(v3s16, v3s16, u32);
extern _EMERGE_CB_onGenerated_V _EMERGE_CB_onGenerated;
