...
using _callback__2_IM = bool(*)(ItemStack&, ServerActiveObject*, const InventoryList*, const InventoryLocation&);

//(ItemStack&, ServerActiveObject*, const InventoryList*, const InventoryLocation &)

extern _callback__2_IM item_OnCraft;
extern _callback__2_IM item_CraftPredict;
...
{
	// Inventory Object
	Inventory *inv_from = nullptr;
	Inventory *inv_to = nullptr;
