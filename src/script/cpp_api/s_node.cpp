...
bool ScriptApiNode::node_on_punch(v3s16 p, MapNode node, ServerActiveObject *puncher, const PointedThing &pointed, uint16_t mapid)
{
...
bool ScriptApiNode::node_on_dig(v3s16 p, MapNode node, ServerActiveObject *digger, uint16_t mapid) {
	SCRIPTAPI_PRECHECKHEADER
...
void ScriptApiNode::node_on_construct(v3s16 p, MapNode node, uint16_t mapid)
{
	SCRIPTAPI_PRECHECKHEADER
...
void ScriptApiNode::node_on_destruct(v3s16 p, MapNode node, uint16_t mapid)
{
	SCRIPTAPI_PRECHECKHEADER
...
void ScriptApiNode::node_after_destruct(v3s16 p, MapNode node, uint16_t mapid)
{
	SCRIPTAPI_PRECHECKHEADER
